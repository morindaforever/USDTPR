  ...
  return (
    <section aria-labelledby="history-heading">
      <div className="mb-3 flex items-center justify-between">
        <h2 id="history-heading" className="text-sm font-semibold text-surface-800">
          Transaction history
        </h2>
        {pagination && (
      ...
      <div className="mb-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
        <select
          ...
          className="rounded-xl border border-surface-200 bg-surface-100 px-3 py-2 text-xs font-medium text-surface-700 focus:border-brand-500/60 focus:outline-none"
        >
      ...
      <Card>
        {state.isLoading ? (
          ...
          <div className="px-4 py-10 text-center">
            <p className="text-sm font-medium text-surface-800">No transactions found</p>
              ...
              return (
                <li key={row.transaction_id} className="flex items-center gap-3 px-4 py-3">
                  <span
                    className={
                      isCredit
                        ? 'inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-brand-500/10 text-brand-400'
        ...
        {pagination && pagination.pages > 1 && !state.isLoading && !state.error && (
          <div className="flex items-center justify-between border-t border-surface-200 px-4 py-3">
            <button
              ...
              className="inline-flex items-center gap-1 rounded-lg border border-surface-300 px-3 py-1.5 text-xs font-semibold text-surface-700 transition-colors hover:bg-surface-200 disabled:cursor-not-allowed disabled:opacity-40"
            >
