...
export function NotFoundPage() {
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-surface-50 px-4 text-center">
      ...
      <p className="mt-6 font-display text-6xl font-extrabold tracking-tight text-surface-800">404</p>
      <h1 className="mt-2 text-lg font-semibold text-surface-800">Page not found</h1>
