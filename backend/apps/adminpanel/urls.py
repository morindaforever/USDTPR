...
urlpatterns = [
    ...
    path('deposits/<str:deposit_id>/note/', finance_views.AdminDepositNoteView.as_view(), name='deposit-note'),
    path('deposits/<str:deposit_id>/screenshot/', finance_views.AdminDepositScreenshotView.as_view(), name='deposit-screenshot'),
    path('networks/', finance_views.AdminNetworkConfigListView.as_view(), name='networks'),
    path('networks/<int:pk>/', finance_views.AdminNetworkConfigListView.as_view(), name='network-detail'),
    # Withdrawals (§24–29)
    ...
    path('withdrawals/<str:withdrawal_id>/qr/', finance_views.AdminWithdrawalQRView.as_view(), name='withdrawal-qr'),
